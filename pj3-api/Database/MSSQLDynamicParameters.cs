...
{
    public class MSSQLDynamicParameters : Dapper.SqlMapper.IDynamicParameters
    {
        ...
        public MSSQLDynamicParameters(object template)
        {
        ...
        public void AddDynamicParams(dynamic param)
        {
            ...
            if (obj != null)
            {
                var subDynamic = obj as MSSQLDynamicParameters;
                if (subDynamic == null)
                {
